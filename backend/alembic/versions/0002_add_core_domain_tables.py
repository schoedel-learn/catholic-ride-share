...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "accepted", "in_progress", "completed", "cancelled", name="riderequeststatus"), nullable=False, server_default="pending"),
    ...
    op.create_table(
        "rides",
        sa.Column("id", sa.Integer(), primary_key=True, index=True),
        sa.Column("ride_request_id", sa.Integer(), sa.ForeignKey("ride_requests.id"), nullable=False, unique=True),
        ...
        sa.Column("actual_pickup_location", Geography(geometry_type="POINT", srid=4326), nullable=True),
        sa.Column("actual_dropoff_location", Geography(geometry_type="POINT", srid=4326), nullable=True),
        sa.Column("status", sa.Enum("accepted", "driver_enroute", "arrived", "picked_up", "in_progress", "completed", "cancelled", name="ridestatus"), nullable=False, server_default="accepted"),
        sa.Column("created_at", sa.DateTime(), nullable=False),
